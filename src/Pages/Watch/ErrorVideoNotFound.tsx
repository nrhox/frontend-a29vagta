export default function ErrorVideoNotFound() {
  return (
    <div className="mb-3 max-w-full md:mx-5 md:mr-8 md:mb-4 lg:max-w-[70%] lg:min-w-[50%]">
      <div className="flex aspect-[8.7/4.9] w-full items-center justify-center bg-gray-400/80 bg-cover text-center text-xl text-black capitalize dark:bg-gray-700 dark:text-white">
        video tidak ada
      </div>
